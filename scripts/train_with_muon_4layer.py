...
def encode_story_files(data_dir: Path, tokenizer: BPETokenizer, file_pattern: str = "story_*.txt") -> list:
...
def fast_encode_documents(text: str, tokenizer: BPETokenizer, doc_separator: str = "\n\n") -> list:
...
def main():
    ...
    TOKENIZER_PATH = PROJECT_ROOT / "models" / "tokenizer_10k" / "tokenizer"
    OUTPUT_DIR = PROJECT_ROOT / "muon_model_4layer"
    ...
    LABEL_SMOOTHING = 0.05  # Lower smoothing allows lower loss floor
    ...
    TOKENIZED_DIR = PROJECT_ROOT / "data" / "tokenized_500k_10k"
